  ...
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        centerTitle: true,
        titleTextStyle: TextStyle(color: isDarkTheme ? Colors.white : Colors.black, fontWeight: FontWeight.normal),
      ...
      colorScheme: ColorScheme.fromSwatch(
        ...
        background: isDarkTheme ? const Color(0xff131218) : const Color(0xffF1F5FB),
      ),
    );
  }
}
